...
public class Info7ImplementOffset extends Fragment implements TextWatcher {
	public EditText editTextImplementOffset;
	private ImageButton btnHelpImplementOffset;
	private ImageButton btnCloseImplementOffset;
	@Override
	...
	public View onCreateView(LayoutInflater inflater,
		...
		btnHelpImplementOffset.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				tv_title.setText(getString(R.string.info_fragment8_implement_offset));
				TextView tv_message = (TextView)window.findViewById(R.id.dialog_message);
				tv_message.setText(getString(R.string.info_fragment8_tips));
				btnCloseImplementOffset = (ImageButton)window.findViewById(R.id.dialog_close);
				
				//按到关闭键即可关闭提示（或者焦点离开提示框时也可关闭提示）
				btnCloseImplementOffset.setOnClickListener(new OnClickListener() {
	...
	public void onTextChanged(CharSequence arg0, int arg1, int arg2, int arg3) {
		...
		if (m.txtImplementOffset != null) {
			String s = editTextImplementOffset.getText().toString();
			m.txtImplementOffset.setText(s);
			m.tractorAttributeValue[7] = s;
			m.updateItems();
